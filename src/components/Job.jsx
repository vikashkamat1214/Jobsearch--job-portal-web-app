  ...
  return (
    <div className='p-5 rounded-md shadow-xl bg-white border border-gray-100'>
      ...
      <Button className='p-6' variant='outline' size='icon'>
        <Avatar>
            <AvatarImage src='https://www.shutterstock.com/shutterstock/photos/750240043/display_1500/stock-vector-vector-technology-circle-750240043.jpg'/>
        </Avatar>
      </Button>
      <div>
      ...
      <div className='flex items-center gap-2 mt-4'>
        ...
        <div className='flex items-center gap-4 mt-4'>
            ...
            <Button className='text-white bg-[#6A38C2]'>Save For Later</Button>
        </div>
    </div>
  )
}
